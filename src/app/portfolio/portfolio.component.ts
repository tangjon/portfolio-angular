...
export class PortfolioComponent implements OnInit {
  ...
  constructor() {
    this.PROJECTS = [];
    this.PROJECTS.push(new PortfolioItem('Job Distribution System', 'assets/img/thumbnail.png', 'August 2018'));
    this.PROJECTS.push(new PortfolioItem('PC Part Picker', 'assets/img/thumbnail.png', 'January 2018'));
